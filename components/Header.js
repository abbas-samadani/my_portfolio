...
const Header = () => {
  ...
  return (
    <>
      ...
      >
        <div
          className={`absolute bg-brand opacity-80 transition duration-500 w-16 h-16 rounded-full ${open && "scale-[55] opacity-60"
            } `}
        ></div>
        ...
        <ul
          className={`absolute h-screen w-screen top-[-50px] justify-evenly items-center flex flex-col gap-6 left-[-20px] text-4xl text-white p-10 ${!open && "hidden"
            }`}
        >
